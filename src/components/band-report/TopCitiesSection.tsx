...
export function TopCitiesSection({ buckets }: TopCitiesSectionProps) {
  if (buckets.length === 0) {
    return (
      <div className="bg-gray-50 border border-gray-300 rounded-2xl p-6">
        <p className="text-gray-500 text-center">No top cities data available yet</p>
      </div>
    )
  }
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-300">
              ...
              <th className="text-left py-2 px-2 sm:px-3 lg:px-4 text-xs sm:text-sm font-medium text-gray-600 whitespace-nowrap">City</th>
