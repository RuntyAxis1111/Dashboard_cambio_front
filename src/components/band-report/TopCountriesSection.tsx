        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-300">
              ...
              <th className="text-left py-2 px-3 text-sm font-medium text-gray-600">Country</th>
              <th className="text-right py-2 px-3 text-sm font-medium text-gray-600">Listeners</th>
            </tr>
          </thead>
          <tbody>
            {buckets.map((item, idx) => (
              <tr key={idx} className="border-b border-gray-200 last:border-0">
                <td className="py-2 px-3 text-sm text-gray-600">{item.posicion}</td>
                <td className="py-2 px-3 text-sm text-gray-700 font-medium">{item.bucket}</td>
                <td className="py-2 px-3 text-sm text-right font-semibold text-black">
