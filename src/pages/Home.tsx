      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Open Dashboards</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Open AI Studio</h3>
            <p className="text-neutral-400 leading-relaxed">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-3">Create Subscription</h3>
            <p className="text-neutral-400 leading-relaxed">
